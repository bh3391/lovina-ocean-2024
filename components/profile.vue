        ...
        <div class="container px-5 py-24 mx-auto flex flex-col">
            <div class="lg:w-4/6 mx-auto">
                    ...
                    <div class=" flex  flex-col sm:flex-row text-center justify-center sm:pr-8 sm:py-8">
                        <div
                            class="w-full inline-flex items-center  text-gray-400">
                            <div>
                            <nuxt-img  class="rounded" loading="lazy" width="300" height="300" format="webp" src="/kadeksuara.png" alt="Foto Pak Kadek"/>
