<template>
    <div class="container lg:w-2/3 text-white mx-auto text-justify p-5">
        
        
        <h1 class="my-10 font-bold text-3xl">Exploring the Natural Beauty and Charm of Lovina, Bali</h1>
